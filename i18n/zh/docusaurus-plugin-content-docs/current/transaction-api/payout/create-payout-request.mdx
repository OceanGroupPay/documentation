...
| `methodType` | String | Yes | Type of Method, please refer to [Payment List](/docs/appendix/payment-method)                 | ""         |
...
:::info
{"order":{"id":"10006","amount":"1","currencyType":"MYR"},"recipient":{"name":"Leon Tan","phone":"0123456789","email":"leon@gggpay.org","methodType":"CIBBMYKL","methodValue":"7048880588","methodRef":""}}
:::
...
### Step 4: POST to `/gggpay/withdrawRequest` endpoint

**Method :** <span style={{ color: "orange", fontWeight: "bold" }}>POST</span><br/>
**Endpoint:** https://api.gggpay.org/gggpay/withdrawRequest
