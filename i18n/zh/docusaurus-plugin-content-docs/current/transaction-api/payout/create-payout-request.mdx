...
| 参数   |  类型  | 必填 | 说明               |     示例      |
| ------------- | ------ | -------- | -------------------------------------- | ---------- |
| `name`      | String | 是      | 客户名字| "Leon Tan" |
| `email`       | String | 是 | 客户邮箱                         | ""         |
| `phone` | String | 是 | 客户电话                 | ""         |
| `methodType` | String | 是 | 列表 [支付列表](/docs/appendix/payment-method)                 | ""         |
...
### 第 4 步：POST 到 `/gggpay/withdrawRequest` 接口

**方式 :** <span style={{ color: "orange", fontWeight: "bold" }}>POST</span><br/>
**接口:** https://api.gggpay.org/gggpay/withdrawRequest
