...
:::info
{"customer":{"name":"Leon Tan","phone":"0123456789","email":"leon@gggpay.org"},"method":"FPX","order":{"id":"A20221111","title":"Payment","amount":"88.50","currencyType":"MYR","additionalData":""}}
:::
...
### Step 4: POST to `/gggpay/createOrder` endpoint

**Method :** <span style={{ color: "orange", fontWeight: "bold" }}>POST</span><br/>
**Endpoint:** https://api.gggpay.org/gggpay/createOrder
